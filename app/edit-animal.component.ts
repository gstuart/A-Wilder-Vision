    ...
    <div >
      ...
      <fieldset *ngIf="childSelectedAnimal">
          ...
          <label for="species">Species</label>
            <input [(ngModel)]="childSelectedAnimal.species" id="species" type="text">
          <label for="name">Name</label>
            <input [(ngModel)]="childSelectedAnimal.name" id="name" type="text">
          <label for="age">Age</label>
            <input [(ngModel)]="childSelectedAnimal.age" id="age" type="text">
          <label for="diet">Diet</label>
            <select [(ngModel)]="childSelectedAnimal.diet" id="diet">
          ...
          <label for="location">Location</label>
            <select [(ngModel)]="childSelectedAnimal.location" id="location">
          ...
          <label for="caretakers">Caretakers</label>
            <select [(ngModel)]="childSelectedAnimal.caretakers" id="caretakers">
                <option>1</option>
                <option>2</option>
                <option>3</option>
                <option>4</option>
          ...
          <label for="gender">Gender</label>
            <select [(ngModel)]="childSelectedAnimal.gender" id="gender">
                <option>Male</option>
                <option>Female</option>
                <option>Unknown</option>
            </select>
          <label for="likes">Likes</label>
            <input [(ngModel)]="childSelectedAnimal.likes" id="likes" type="text">
          <label for="dislikes">Dislikes</label>
            <input [(ngModel)]="childSelectedAnimal.dislikes" id="dislikes" type="text">
